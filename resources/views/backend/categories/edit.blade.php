...
@section('page-title', 'Wijzig ' . $category->name)

@section('title')
	<h1>Wijzig <strong>{{ $category->name }}</strong> <small>categorie beheer</small></h1>
@endsection
...
@section('breadcrumb')
	<ol class="breadcrumb">
        ...
        <li class="active">Wijzig categorie</li>
    </ol>
@endsection
...
@section('content')
	<div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Wijzig categorie</h3>
        </div>
        <div class="box-body">
            ...
            <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="form-horizontal">
                ...
                @method('PATCH')	{{-- Form method spoofing --}}
                @form($category)	{{-- Connect the database data to the form. --}}

                <div class="form-group @error('name', 'has-error')">
                    <label for="name" class="control-label col-md-2">Naam van de categorie: <span class="text-danger">*</span></label>

                    <div class="col-md-5">
                        <input type="text" id="name" class="form-control" placeholder="Naam van de categorie" @input('name')>
                        @error('name')
                    </div>
                </div>
                ...
                <div class="form-group @error('description', 'has-error')">
                    ...
                    <div class="col-md-10">
                        <textarea rows="5" @input('description') class="form-control" placeholder="Korte beschrijving van de categorie">{{ $category->description or old('description') }}</textarea>
                ...
                <div class="form-group">
                    <div class="col-md-offset-2 col-md-10">
                        <button type="submit" class="btn btn-sm btn-success">
                            <i class="fa fa-fw fa-check"></i> Wijzigen
                        </button>
